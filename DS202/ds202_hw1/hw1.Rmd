...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: Hello my name is **John Barmen**, I am a senior *Computer Science* major.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: I think that I would like to work in be a server admin for a large company.
    
    ![Alt text](http://www.justinhallcomics.com/wp-content/uploads/2018/08/What-is-a-Network-Server.jpg)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: Personally i think that data mining large sets of records is an interesting use of data science principles and plan to try and use it any job i find myself in.
...
<!-- Then explore the bash command line and Git. -->
    ...
    Answer: Done; 'git version 2.30.0.windows.2'
